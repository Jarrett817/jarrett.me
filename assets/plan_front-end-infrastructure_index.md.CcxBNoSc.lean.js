import{g as C,a3 as r,H as g,E as y,a4 as a,Q as i,f as h,aj as l,K as A,bY as u,bZ as D,b_ as m,b$ as B,c0 as b,c1 as f,c2 as x,c3 as S}from"./chunks/framework.D0OZbHhS.js";import{v as n}from"./chunks/theme.DOKpOaQe.js";import{A as T}from"./chunks/ApiTest.CJIz8nH7.js";import{_,a as v}from"./chunks/Zod.vue_vue_type_script_setup_true_lang.DU79aOe_.js";/* empty css                                                                       */const P={class:"h-500px"},I=C({__name:"Intro",setup(F){const k={direction:1},p={topic:"项目迭代",id:n(),expanded:!0,children:[{id:n(),topic:"开发前期",children:[{id:n(),topic:"接口文档"},{id:n(),topic:"接口数据mock"},{id:n(),topic:"编译时类型校验"},{id:n(),topic:"运行时接口数据校验"}]},{id:n(),topic:"前后端联调",children:[{id:n(),topic:"接口文档改动diff、历史记录"},{id:n(),topic:"接口mock"}]},{id:n(),topic:"测试上线",children:[{id:n(),topic:"运行时接口数据校验、日志上报"}]}]};return(E,d)=>{const e=r("MindMap");return g(),y("div",P,[a(e,{data:{nodeData:p},options:k},null,8,["data"])])}}}),w=JSON.parse('{"title":"前端基建 ——— 接口、数据、类型在前端开发中的管理及应用","description":"","frontmatter":{},"headers":[],"relativePath":"plan/front-end-infrastructure/index.md","filePath":"plan/front-end-infrastructure/index.md","lastUpdated":1782453294000}'),q={name:"plan/front-end-infrastructure/index.md"},L=Object.assign(q,{setup(F){const k=`
